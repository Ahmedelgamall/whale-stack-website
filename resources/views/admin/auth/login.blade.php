...
<head>
    ...
    <meta name="description" content="Coffee admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, Coffee admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>Login - {{ getSettingOf('website_name') }}</title>
            ...
            <div class="auth-wrapper auth-cover">
                <div class="auth-inner row m-0">
                    <!-- Brand logo--><a class="brand-logo" href="javascript:;">
                        ...
                        <h2 class="brand-text text-primary ms-1">{{ getSettingOf('website_name') }}</h2>
                    </a>
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <h2 class="card-title fw-bold mb-1">Welcome to {{ getSettingOf('website_name') }}! 👋</h2>

                            <form class="mt-2 form" action="{{route('admin.doLogin')}}" method="POST">
                                @csrf
...
<script src="{{asset('assets/admin')}}/app-assets/js/scripts/extensions/ext-component-toastr.js"></script>
