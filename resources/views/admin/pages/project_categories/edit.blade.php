        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" action="{{ route(@$data['route'] . '.update', @$row->id) }}"
                            method="post">
                            @csrf
                            @method('put')
                                        ...
                                        <div class="tab-pane fade {{ $loop->first ? 'active' : '' }} show"
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea name="{{ $lang->locale }}[description]" class="form-control" id="description">{{ @$row->translate($lang->locale)['description'] }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
