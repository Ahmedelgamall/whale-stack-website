        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" action="{{route(@$data['route'].'.update',$product->id)}}" method="post">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="first-name-column">اسم الصنف</label>
                                        <input type="text" id="first-name-column" class="form-control" placeholder="Name" name="name" value="{{@$product->name}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="number" id="first-name-column" class="form-control" placeholder="0.0" name="unit_price" step="any" value="{{@$product->unit_price}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="number" id="first-name-column" class="form-control" placeholder="0.0" name="quantity" step="any" value="{{@$product->quantity}}">
                                    </div>
                                </div>
                                    ...
                                    <div class="row parent">
                                        ...
                                        <div class="col-md-2 col-2">
                                            <div class="mb-1">
                                                ...
                                                <img width="100" class="preview" height="100" src="{{getFile(@$product->photo)}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
