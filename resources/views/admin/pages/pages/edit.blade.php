            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">{{@$page->translate(config('app.locale'))['title']}}
                        </li>
                            ...
                            <div class="tab-pane fade {{$loop->first ? 'active':''}} show" id="{{$lang->locale}}" role="tabpanel" aria-labelledby="nav-{{$lang->locale}}" tabindex="0">
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="Title" value="{{@$page->translate($lang->locale)['title']}}" class="form-control name_{{$lang->locale}}" placeholder="Title" name="{{$lang->locale}}[title]">
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="slug">Slug ( {{$lang->name}} ) </label>
                                        <input type="text" readonly value="{{@$page->translate($lang->locale)['slug']}}" id="slug" class="form-control  slug_{{$lang->locale}}" placeholder="slug" name="{{$lang->locale}}[slug]">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea class="form-control" name="{{$lang->locale}}[description]">{{@$page->translate($lang->locale)['description']}}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row parent">
                                ...
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        ...
                                        <img width="100" class="preview" height="100" src="{{getFile($page->photo)}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
