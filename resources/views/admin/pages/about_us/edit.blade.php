            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">{{@$raw->translate(config('app.locale'))['title']}}
                        </li>
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form" action="{{route('about.update',$raw->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <input type="hidden" value="{{$raw->id}}" name="id">
                <div class="row mt-1">
                    <nav>
                            ...
                            <div class="tab-pane fade {{$loop->first ? 'active':''}} show" id="{{$lang->locale}}" role="tabpanel" aria-labelledby="nav-{{$lang->locale}}" tabindex="0">
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="Title" value="{{$raw != null?@$raw->translate($lang->locale)['title']:''}}" class="form-control" placeholder="Title" name="{{$lang->locale}}[title]">
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="description">Description ( {{$lang->name}} )</label>
                                        <textarea class="form-control" name="{{$lang->locale}}[description]">{{$raw != null?@$raw->translate($lang->locale)['description']:''}}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row parent">
                                <div class="col-md-8 col-8">
                                    <div class="mb-1">
                                        ...
                                        <input type="file" id="first-name-column" class="form-control photo" placeholder="photo" name="photo" value="{{$raw->photo}}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-4">
                                    <div class="mb-1">
                                        <label class="form-label" for="first-name-column"></label>
                                        <img width="100" class="preview" height="100" src="{{getFile($raw->photo)}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
