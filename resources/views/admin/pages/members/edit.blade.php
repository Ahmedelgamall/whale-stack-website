                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <textarea name="{{ $lang->locale }}[message]" id="message" class="form-control">{{ @$row->translate($lang->locale)['message'] }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    {{-- <div class="col-md-6 col-6">
                                        ...
                                        <div class="d-flex flex-column mb-5">
                                            <label class="form-check-label mb-50" for="customSwitch4">Is CEO</label>
                                            <div class="form-check form-check-success form-switch">
                                                <input type="checkbox" name="is_ceo" value="1"
                                                    {{ @$row->is_ceo == true ? 'checked' : '' }} class="form-check-input"
                                                    id="customSwitch4">
                                            </div>
                                        </div>
                                    </div> --}}
