            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <a class="btn btn-danger btn-sm delete_selected d-none"><i class="fa fa-trash"></i> Delete
                            Selected</a>
                        {{-- <a href="{{ route(@$data['route'] . '.create') }}" class="btn btn-primary btn-sm"><i
                                class="fa fa-plus"></i> {{ @$data['create'] }}</a> --}}
                    </div>
