            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add New {{@$data['page_title']}}</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="last-name-column" class="form-control" placeholder="ar / en" name="locale">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="abbr">abbr</label>
                                        <input type="text" id="abbr" class="form-control" placeholder="eg / kw" name="abbr">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="mb-1">
                                        ...
                                        <div class="form-check form-check-success form-switch">
                                            <input type="checkbox" checked="" name="status" value="1" class="form-check-input" id="customSwitch4">
                                        </div>
                                    </div>
                                </div>
