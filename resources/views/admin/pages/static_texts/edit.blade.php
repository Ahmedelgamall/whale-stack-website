                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select name="section" id="Page" class="form-control">
                                                    ...
                                                    @foreach (App\Enums\SectionType::cases() as $case)
                                                        <option value="{{ $case->value }}" {{ $case->value == @$row->section->value ? 'selected' : '' }}>
                                                            {{ $case->label() }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="tab-pane fade {{ $loop->first ? 'active' : '' }} show"
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea name="{{ $lang->locale }}[description]" id="Content" class="form-control">{{ @$row->translate($lang->locale)['description'] }}</textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="url" id="Link" class="form-control"
                                                placeholder="ex:https://www.example.com" name="url"
                                                value="{{ @$row->url }}">
                                        </div>
                                    </div>
